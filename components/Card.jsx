...
const Card = ({ title, amount, desc, date, account }) => {

    const router = useRouter();
    const handleClick = () => {
        router.push(`/${account}`);
    }
console.log('Now need contract address', account);
    return (
        <div className="flex shadow-lg  mx-6 md:mx-auto my-8 md:max-w-2xl h-72">
            ...
            <div className="w-full relative md:w-2/3 px-4 py-4 bg-white rounded-lg">
                ...
                <div className="grid grid-cols-2 items-center bg-white rounded-xl mt-4 space-y-1 w-full">
